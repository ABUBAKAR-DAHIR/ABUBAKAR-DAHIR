...
<h3 align="center">Full-Stack Engineer · Rust Backend Developer · Cloud & DevOps</h3>

<p align="center">
  I build scalable web applications, reliable backend systems, and production-style cloud infrastructure.
</p>
...
I'm a Full-Stack Software Engineer building scalable web applications, reliable Rust backend services, and production-style cloud infrastructure. I work across the stack — from responsive user interfaces and well-designed APIs to secure backend systems and AWS infrastructure managed with Terraform.

I'm passionate about system design, cloud architecture, DevOps, and building clean, maintainable solutions to real-world problems.
...
* ⚛️ **Full-Stack Development** — React, Next.js, Node.js, NestJS, TypeScript, Prisma & PostgreSQL
* 🦀 **Backend Engineering** — Rust, Axum, Tokio, SQLx, PostgreSQL, Authentication & API Development
* ☁️ **Cloud & DevOps** — AWS, Terraform, Linux, Nginx, Infrastructure as Code & Deployment
* 🏗️ **System Design** — Scalable Architecture, Secure Systems, Networking & Production Engineering
* 🧠 **Problem Solving** — Data Structures, Algorithms & Writing Clean, Maintainable Code
...
![SQLx](https://img.shields.io/badge/-SQLx-4479A1?style=flat&logo=postgresql&logoColor=white)
![PASETO](https://img.shields.io/badge/-PASETO-6B21A8?style=flat&logo=rust&logoColor=white)
...
<p align="center"> <img src="https://streak-stats.demolab.com/?user=ABUBAKAR-DAHIR&theme=tokyonight&hide_border=true" width="48%" /> </p> 
